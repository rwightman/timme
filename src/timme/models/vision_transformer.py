...
VIT_CFGS = {
    ...
    # TIPSv2 — DINOv2-style ViT w/ 1 register token, LayerScale init=1.0, no_embed_class.
    'vit_base_patch14_reg1_tipsv2': VisionTransformerCfg(
        img_size=448,
        patch_size=14,
        embed_dim=768,
        depth=12,
    ...
    'vit_large_patch14_reg1_tipsv2': VisionTransformerCfg(
        img_size=448,
        patch_size=14,
        embed_dim=1024,
        depth=24,
    ...
    'vit_so400m_patch14_reg1_tipsv2': VisionTransformerCfg(
        img_size=448,
        patch_size=14,
        embed_dim=1152,
        depth=27,
    ...
    'vit_giant_patch14_reg1_tipsv2': VisionTransformerCfg(
        img_size=448,
        patch_size=14,
        embed_dim=1536,
        depth=40,
