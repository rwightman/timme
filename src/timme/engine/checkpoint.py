...
from timme.task import resume_task_checkpoint
from timme.task.checkpoint_saver import CheckpointSaver
...
def setup_checkpoint_saver(
    ...
    task = model if hasattr(model, 'get_checkpoint_state') else None
