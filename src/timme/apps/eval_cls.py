...
from timme import create_model, is_registered, list_models
...
_logger = logging.getLogger('timme.eval_cls')
...
def validate(args):
    ...
    if args.naflex_loader:
        ...
        elif hasattr(model, 'embeds') and hasattr(model.embeds, 'patch_size'):
...
def main():
    ...
    if os.path.isdir(args.checkpoint):
        ...
        elif not is_registered(args.model):
