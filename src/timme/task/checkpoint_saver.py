...
class CheckpointSaver:
    ...
    def _save(self, save_path, epoch, metric=None):
        ...
        if self.task is not None:
            ...
            save_state['state_dict'] = clean_state_dict(get_state_dict(self.model, self.unwrap_fn))
            if self.model_ema is not None:
                save_state['state_dict_ema'] = clean_state_dict(get_state_dict(self.model_ema, self.unwrap_fn))
